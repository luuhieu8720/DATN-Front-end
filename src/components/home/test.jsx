        ...
        <body>
            ...
            <main>
                ...
                <div class="d-flex flex-column flex-shrink-0 p-3 bg-light">
                    ...
                    <hr />
                    <div class="dropdown">
                        <Link to="/" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle" id="dropdownUser2" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="d-flex flex-column flex-shrink-0 bg-light">
                    <Link to="/" class="d-block p-3 link-dark text-decoration-none" title="Icon-only" data-bs-toggle="tooltip" data-bs-placement="right">
                        <svg class="bi" width="40" height="32"></svg>
                        <span class="visually-hidden">Icon-only</span>
                    </Link>
                    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                        <li class="nav-item">
                            <Link to="/" class="nav-link active py-3 border-bottom" aria-current="page" title="Home" data-bs-toggle="tooltip" data-bs-placement="right">
                                <svg class="bi" width="24" height="24" role="img" aria-label="Home"></svg>
                            </Link>
                        </li>
                        <li>
                            <Link to="/" class="nav-link py-3 border-bottom" title="Dashboard" data-bs-toggle="tooltip" data-bs-placement="right">
                                <svg class="bi" width="24" height="24" role="img" aria-label="Dashboard"></svg>
                            </Link>
                        </li>
                        <li>
                            <Link to="/" class="nav-link py-3 border-bottom" title="Orders" data-bs-toggle="tooltip" data-bs-placement="right">
                                <svg class="bi" width="24" height="24" role="img" aria-label="Orders"></svg>
                            </Link>
                        </li>
                        <li>
                            <Link to="/" class="nav-link py-3 border-bottom" title="Products" data-bs-toggle="tooltip" data-bs-placement="right">
                                <svg class="bi" width="24" height="24" role="img" aria-label="Products"></svg>
                            </Link>
                        </li>
                        <li>
                            <Link to="/" class="nav-link py-3 border-bottom" title="Customers" data-bs-toggle="tooltip" data-bs-placement="right">
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="home-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><Link to="/" class="link-dark rounded">Updates</Link></li>
                                    <li><Link to="/" class="link-dark rounded">Reports</Link></li>
                                </ul>
                            </div>
                        </li>
                        <li class="mb-1">

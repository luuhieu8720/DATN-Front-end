...
export class Client {
     ...
     * @return Success
     */
    change(code: string | null | undefined, email: string | null | undefined, password: string): Promise<void> {
     ...
     * @return Success
     */
    reportsPOST(createdTime: Date | undefined, updatedTime: Date | undefined, content: string | null | undefined, userId: string | undefined, file: FileParameter | null | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/reports?";
        if (createdTime === null)
            throw new Error("The parameter 'createdTime' cannot be null.");
        else if (createdTime !== undefined)
            url_ += "CreatedTime=" + encodeURIComponent(createdTime ? "" + createdTime.toISOString() : "") + "&";
        if (updatedTime === null)
            throw new Error("The parameter 'updatedTime' cannot be null.");
        else if (updatedTime !== undefined)
            url_ += "UpdatedTime=" + encodeURIComponent(updatedTime ? "" + updatedTime.toISOString() : "") + "&";
     ...
     * @return Success
     */
    reportsPUT(id: string, createdTime: Date | undefined, updatedTime: Date | undefined, content: string | null | undefined, userId: string | undefined, file: FileParameter | null | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/reports/{id}?";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
     ...
     * @return Success
     */
    timekeepingPUT(id: string, body: TimeKeepingForm | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/timekeeping/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
